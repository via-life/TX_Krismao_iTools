...
需求一和需求三共用本地安装的 iTools Chromium 浏览器助手 2.1.6：
...
首次使用时，从本地交付目录选择 `iTools浏览器助手-v2.1.6`：在 Chrome 打开 `chrome://extensions/`，或在 Edge 打开 `edge://extensions/`，开启开发者模式，点击“加载已解压的扩展程序”，然后刷新需求一或需求三页面。
